...
L["Lime_profile_1m"]="1인"
L["Lime_profile_5m"]="5인"
L["Lime_profile_10m"]="10인"
L["Lime_profile_25m"]="25인"
L["Lime_profile_40m"]="40인"
L["Lime_profile_spec"]="특성"
L["Lime_profile_spec1"]="1특성"
L["Lime_profile_spec2"]="2특성"
...
L["library_3"] = ",SmoothBar(체력바 애니메이션)"
L["library_9"] = " 외부 라이브러리 로드-"
L["library_10"] = " 외부 라이브러리 로드 없음"
...
L["ClickCast_desc1"]="클릭캐스트 정보가 특성별로 복사되었습니다."
...
L["lime_survival_천수"] = "천수"
L["lime_survival_무적성희"] = "무적성희"
...
L["lime_survival_보축"] = "보손"
L["lime_survival_수호"] = "수호"
L["lime_survival_고억"] = "고억"
L["lime_survival_희축"] = "희손"
...
L["프레임이동msg"]="전투중에는 프레임을 이동할 수 없습니다."

L["플레이어위치1"]="지정안함"
L["플레이어위치2"]="항상 위"
L["플레이어위치3"]="항상 아래"
L["플레이어위치"]="플레이어 위치"
L["플레이어위치_desc"]="플레이어를 항상 지정된 위치에 표시합니다.파티 및 투기장에만 적용됩니다."
...
L["lime_advanced_08"] = "SHIFT키 공대원 이동"
L["lime_advanced_desc_08"] = "SHIFT+드래그를 사용하여 공대원 위치를 교체합니다. 파티 헤더에 드래그할 경우 해당 파티에 추가할 수 있습니다."
...
L["보호막 시전"]="보호막 시전"
L["순차선택"]="순차선택"
L["순차선택_desc"]="순차적인 파티/공대원 선택 기능을 활성화합니다. 설정 후 단축키 설정에서 이전/다음 대상키를 지정합니다."
L["파티/공대원 선택"]="파티/공대원 선택"
L["순차선택 옵션"]="예외옵션"
L["순차선택 옵션_desc"]="공격대의 경우 주문 시전시 방어전담만 제외하거나 포함합니다."

L["IRF3 Party Target Forward"]="IRF3:다음 파티원 선택"
L["IRF3 Party Target Backward"]="IRF3:이전 파티원 선택"
L["IRF3 Raid Target Forward"]="IRF3:다음 공대원 선택"
L["IRF3 Raid Target Backward"]="IRF3:이전 공대원 선택"
L["IRF3 Raid Target Melee Forward"]="IRF3:다음 밀리 공대원 선택"
L["IRF3 Raid Target Melee Backward"]="IRF3:이전 밀리 공대원 선택"
...
L["profile_export2"]="선택한 프로필을 문자열로 내보냅니다. 주문타이머 및 클릭캐스팅 정보는 포함되지 않습니다."
L["profile_import"]="가져오기"
L["profile_import2"]="내보내기했던 프로필 내용을 가져옵니다."
L["profile_import3"]="여기에 가져올 문자열을 붙여 넣으십시오.\n예제\n"
L["profile_export3"] ="내보내기: 아래 문자열을 복사하여 다른 계정에서 해당 프로필 내용을 가져올 수 있습니다."
L["profile_import4"] ="가져오기: 아래에 가져온 문자열을 복사하여 새로운 프로필을 생성합니다."
L["profile_import_msg1"] = "새로운 프로필을 가져왔습니다."
L["profile_import_msg2"] = "프로필을 가져오지 못했습니다."
L["profile_import_msg3"] = "동일한 이름의 프로필이 이미 존재합니다."
...
L["lime_layout_09_1"] = "소환자 직업 색상"
L["lime_layout_desc_09_1"] = "소환자의 직업색상을 소환수 체력바 색상으로 사용합니다"
L["lime_layout_09_2"] = "소환수 이름 숨기기"
L["lime_layout_desc_09_2"] = "소환수 이름을 표시하지 않습니다."
L["lime_layout_09_3"] = "이동시 앵커 고정"
L["lime_layout_desc_09_3"] = "프레임 이동시 자동으로 앵커를 고정합니다. 전투중에는 프레임을 이동할 수 없습니다."
L["lime_layout_desc_09_4"] = "전투중에는 애드온을 통한 공격대원 위치 조정을 할 수 없습니다."
...
L["lime_func_1"] = "어그로 화살표 표시"
L["lime_func_1_1"] = "색상 세분화"
...
L["lime_func_17"] = "사정거리 밖 투명도"
L["lime_func_18"] = "이름에도 투명도 적용"
L["lime_func_19"] = "사정거리 밖인 플레이어 이름에도 투명도를 적용합니다."
L["lime_func_20"] = "이전/다음 파티원이나 공대원을 순차적으로 선택하거나 스킬을 시전하게합니다. "
L["lime_func_21"] = "설정>게임>단축키 설정->애드온 항목에서 단축키를 지정하여 활용합니다. "
L["lime_func_22"] = "올바를 index정렬을 위해 전체 공대 구성후 리로드/reload를 권장합니다."

L["lime_func_desc_1"] = "어그로를 획득한 플레이어의 이름 왼쪽에 붉은색 화살표를 표시합니다."
L["lime_func_desc_1_1"] = "어그로에 따라 3가지 색상 화살표로 구분합니다."
L["lime_func_desc_1_2"] = "어그로 색상을 플레이어 이름에 적용합니다."
...
L["lime_func_desc_18"] = "사정거리를 벗어난 플레이어의 체력바 및 아이콘을 투명하게 표시합니다."
...
L["lime_func2_4_1"] = "주요 공대 생존기를 아이콘으로 표기(오라숙련은 추가 부하 발생)"
L["lime_func2_desc_4_1"] = "주요 공대 생존기를 별도 아이콘으로 표기합니다."
L["lime_func2_5"] = "사용하기"
...
L["lime_func2_19"] = "클래식 흡수량 표시"
L["lime_func2_desc_19"] = "클래식에서는 흡수량을 지원하지 않으므로 전투로그에서 해당 주문의 흡수량을 계산합니다(사제 보호막-문양,신의 보호,발아니르)."
L["lime_func2_20"] = "최대체력 이상시 표시 위치"
L["lime_func2_desc_20"] = "보호막 흡수량이 최대 체력 이상일때 표시방식을 선택합니다."
...
L["lime_func_aura_10_13"]="테두리 반짝임"
L["lime_func_aura_10_14"]="해당 유닛의 테두리에 반짝임 효과를 추가합니다."
L["lime_func_aura_10_15"]="테두리 색상"
L["lime_func_aura_10_16"]="테두리 반짝임의 색상을 지정합니다."
...
L["lime_func_aura_18_1"] = "타이머 표시 형식"
L["lime_func_aura_19_1"] = "디버프 타이머의 표시 형식을 설정합니다."
...
L["lime_func_aura_48"] = "현재 특성의 클릭캐스트 정보를 복제하시겠습니까?"
L["lime_func_aura_49"] = "클릭캐스트 정보가 복제되었습니다."
L["lime_func_aura_50"] = "다른 특성으로 복제"
L["lime_func_aura_51"] = "현재 특성의 클릭캐스트정보를 다른 특성에도 복제합니다."
...
L["lime_func_other_26_1"] = "아이콘과 주문명 표시"
L["lime_func_other_26_2"] = "시전중인 주문정보를 표시합니다."
L["lime_func_other_26_3"] = "글꼴 크기를 설정합니다."
...
L["Smoothbar"]="체력바 애니메이션 표시"
L["Smoothbardesc"]="체력바 변동을 부드럽게 표현합니다."

L["클릭 캐스팅 사용"]="클릭 캐스팅 사용(/reload 필요)"
L["클릭 캐스팅 사용desc"]="클릭 캐스트 사용여부를 지정합니다."
L["UseClique"]="Clique사용(/reload 필요)"
L["UseClique_desc"]="기본 클릭캐스트 대신 Clique 애드온을 활용합니다."
L["activateUnitFrame"]="유닛프레임에도 적용(/reload 필요)."
L["activateUnitFrame_desc"]="클릭캐스트를 다른 유닛프레임에도 동일하게 적용합니다(블리자드 기본,인벤유닛프레임,SUF, ELV)"
L["클릭"] ="클릭"
L["Alt + 클릭"] ="Alt + 클릭"
L["Ctrl + 클릭"] ="Ctrl + 클릭"
L["Shift + 클릭"] ="Shift + 클릭"
