...
elseif class == "PRIEST" then
	function scanDispel()
		lib.tranquilize = nil
		lib.harm = IsPlayerSpell(527) and true or nil
		wipe(lib.help)
		lib.help.Disease = IsPlayerSpell(528) and true or nil
--		lib.help.Magic = IsSpellKnown(527) and true or nil
		lib.help.Magic = IsPlayerSpell(527) and true or nil
	end
elseif class == "MAGE" then
	function scanDispel()
		...
		lib.harm = nil
		wipe(lib.help)
		lib.help.Curse = IsPlayerSpell(475) and true or nil
	end
elseif class == "WARLOCK" then
	function scanDispel()
		lib.tranquilize = nil
		lib.harm = IsSpellKnown(19505, true) and true or nil  -- isPetSpell = true
		wipe(lib.help)
	end
...
elseif class == "DRUID" then
	function scanDispel()
		...
		lib.harm = nil
		wipe(lib.help)
		lib.help.Curse = IsPlayerSpell(2782)  and true or nil
		lib.help.Poison = (IsPlayerSpell(8946) or IsPlayerSpell(2893)) and true or nil
	end
elseif class == "SHAMAN" then
	function scanDispel()
		lib.tranquilize = nil
		lib.harm = IsPlayerSpell(370) and true or nil
		wipe(lib.help)
		lib.help.Poison = IsPlayerSpell(526) and true or nil
		lib.help.Disease = IsPlayerSpell(526)  and true or nil
		lib.help.Curse = IsPlayerSpell(51886)  and true or nil
	end
elseif class == "PALADIN" then
	function scanDispel()
		...
		lib.harm = nil
		wipe(lib.help)
		lib.help.Poison = (IsPlayerSpell(1152) or IsPlayerSpell(4987)) and true or nil
		lib.help.Disease = lib.help.Poison
		lib.help.Magic = IsPlayerSpell(4987) and true or nil
	end
elseif class == "MONK" then
	function scanDispel()
		lib.tranquilize = nil
		lib.harm = nil
		lib.help.Poison = (IsPlayerSpell(218164) or IsPlayerSpell(115450)) and true or nil
		lib.help.Disease = lib.help.Poison
		lib.help.Magic = IsPlayerSpell(115450) and true or nil
	end
