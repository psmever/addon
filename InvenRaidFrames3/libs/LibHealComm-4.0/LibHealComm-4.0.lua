	...
	LoadClassData = function()
		...
		if isWrath then
			spellData[HolyLight] = { coeff = 2.5 / 3.5, levels = {1, 6, 14, 22, 30, 38, 46, 54, 60, 62, 70, 75, 80}, averages = {
				...
				{avg(4199, 4677), avg(4209, 4688), avg(4219, 4698), avg(4230, 4709), avg(4240, 4719), avg(4240, 4719)},
				{avg(4888, 5444)} }}
...
-- events and set a playerGUID/playerName combo 	 all players on PLAYER_LOGIN not just the healers.
